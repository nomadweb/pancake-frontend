...
import { ProposalState, ProposalType, VoteLoadingStatus } from 'state/types'
...
const Proposals = () => {
  ...
  const isLoading = proposalStatus === VoteLoadingStatus.LOADING
  const isIdle = proposalStatus === VoteLoadingStatus.IDLE
