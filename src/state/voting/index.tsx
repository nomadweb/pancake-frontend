...
import { Proposal, ProposalState, VoteLoadingStatus, VotingState, Vote } from 'state/types'
import { getAllVotes, getProposal, getProposals } from './helpers'

const initialState: VotingState = {
  proposalLoadingStatus: VoteLoadingStatus.INITIAL,
  proposals: {},
  voteLoadingStatus: VoteLoadingStatus.INITIAL,
  votes: {},
}
...
export const votingSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(fetchProposals.pending, (state) => {
      state.proposalLoadingStatus = VoteLoadingStatus.LOADING
    })
    builder.addCase(fetchProposals.fulfilled, (state, action) => {
      ...
      state.proposalLoadingStatus = VoteLoadingStatus.IDLE
    })
    ...
    builder.addCase(fetchVotes.pending, (state) => {
      state.voteLoadingStatus = VoteLoadingStatus.LOADING
    })
    builder.addCase(fetchVotes.fulfilled, (state, action) => {
      ...
      state.voteLoadingStatus = VoteLoadingStatus.IDLE
    })
  },
})
